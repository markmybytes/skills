...
污染警報：官腔搭配（土地到位、全力推進、抓好落實）喺訓練料出現極頻繁——
你嘅「讀得順」直覺可能已經被污染。
搭配對錯唔靠語感，靠測試。對自己寫嘅替換詞、同原文疑點搭配都做：

1. 定義測試：用一句講出動詞定義，受詞符合定義條件嗎？
   「落成」=建築物完工；土地唔係建築物 → 廢。
2. Pivot 測試：改成直白中文或英文講一次——講唔順 → 廢。
   「土地落成」→ the land was completed：明顯唔自然。
3. 畫面測試：想像唔到個動作實際發生 → 疑，返查。
